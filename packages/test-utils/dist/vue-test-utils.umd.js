(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('vue'), require('shared/validators'), require('shared/util'), require('dom-event-types'), require('create-instance'), require('shared/merge-options')) :
  typeof define === 'function' && define.amd ? define(['vue', 'shared/validators', 'shared/util', 'dom-event-types', 'create-instance', 'shared/merge-options'], factory) :
  (global.VueTestUtils = factory(global.Vue,null,null,null,null,null));
}(this, (function (Vue,validators,util,eventTypes,createInstance,mergeOptions) { 'use strict';
